...
import com.shawckz.reflex.core.cmd.CmdArgs;
import com.shawckz.reflex.core.cmd.Command;
import com.shawckz.reflex.core.cmd.ReflexCommand;
...
public class CommandHelp implements ReflexCommand {
    ...
    public void onCommand(CmdArgs cmdArgs) {
        ...
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&7v"+Reflex.getInstance().getDescription().getVersion()+" by Shawckz"));
